...
sorted_scores = sorted(list(set([student_grades[i][1] for i in range(len(student_grades))])))   
second_low = sorted_scores[1]
       
for i in range(len(student_grades)):
    if student_grades[i][1] == second_low:
        print(student_grades[i][0]) 
